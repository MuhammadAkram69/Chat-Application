...
const ChatPage = () => {
  ...
  return (
    <Box className="chat-container">
      ...
      {token ? <Grid container spacing={2} className="chat-main-container">
        <Grid xs={3} item>
                  ...
                  <Box className="searched-contacts-container">
                    {searchedContacts
                      ...
                      .map((people, index) => {
                        return (
                          <Box
                            className={`chat-people ${people.userId === selectedContact
                              ? "color-blue"
                              : ""
                              }`}
                            key={index}
              ...
              <Box className="chat-people-box">
                <>
                  {excludeLogedUser.map((people, index) => {
                    return (
                      <Box
                        className={`chat-people ${people.userId === selectedContact ? "color-blue" : ""
                          }`}
                        key={index}
                        onClick={() => selectContactHandler(people)}
                      >
        ...
        <span style={{ margin: '100px auto' }}>Please Register Yourself to use this Chat Application!</span>
      }
    </Box>
  );
};
